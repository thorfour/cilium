...
require (
	...
	github.com/cilium/proxy v0.0.0-20190415205506-f65bc191a9b9
	...
	github.com/miekg/dns v1.1.4-0.20190417235132-8e25ec9a0ff3
	...
	github.com/vishvananda/netlink v0.0.0-20190719002653-b1e985979217
...
replace (
	...
	github.com/aws/aws-sdk-go-v2 => github.com/aws/aws-sdk-go-v2 v0.10.0
	...
	github.com/cilium/proxy => github.com/cilium/proxy v0.0.0-20190415205506-f65bc191a9b9
	...
	github.com/containerd/containerd => github.com/containerd/containerd v1.2.7
	...
	github.com/docker/docker => github.com/docker/docker v0.7.3-0.20190211062442-f18cf23e97b0
	github.com/docker/go-connections => github.com/docker/go-connections v0.3.0
	github.com/docker/go-events => github.com/docker/go-events v0.0.0-20170721190031-9461782956ad
	...
	github.com/envoyproxy/protoc-gen-validate => github.com/envoyproxy/protoc-gen-validate v0.0.14
	...
	github.com/fatih/color => github.com/fatih/color v0.0.0-20181010231311-3f9d52f7176a
	...
	github.com/go-openapi/analysis => github.com/go-openapi/analysis v0.18.0
	...
	github.com/go-openapi/runtime => github.com/go-openapi/runtime v0.19.2
	...
	github.com/gogo/googleapis => github.com/gogo/googleapis v1.2.0
	...
	github.com/gucumber/gucumber => github.com/gucumber/gucumber v0.0.0-20180127021336-7d5c79e832a2
	github.com/hailocab/go-hostpool => github.com/hailocab/go-hostpool v0.0.0-20160125115350-e80d13ce29ed
	github.com/hashicorp/consul => github.com/hashicorp/consul v1.5.3
	...
	github.com/hashicorp/go-bexpr => github.com/hashicorp/go-bexpr v0.1.0
	...
	github.com/hashicorp/serf => github.com/hashicorp/serf v0.8.3
	...
	github.com/kevinburke/ssh_config => github.com/kevinburke/ssh_config v0.0.0-20190724205821-6cfae18c12b8
	...
	github.com/shiena/ansicolor => github.com/shiena/ansicolor v0.0.0-20151119151921-a422bbe96644
	github.com/shirou/gopsutil => github.com/shirou/gopsutil v0.0.0-20190627142359-4c8b404ee5c5
	...
	github.com/spf13/afero => github.com/spf13/afero v1.1.2
	...
	github.com/vishvananda/netlink => github.com/vishvananda/netlink v0.0.0-20190719002653-b1e985979217
	...
	go.mongodb.org/mongo-driver => go.mongodb.org/mongo-driver v1.0.3
	...
	// v0.0.0-20190612082741-7dcec919a2e5 -> k8s v1.15.1
	k8s.io/api => k8s.io/kubernetes/staging/src/k8s.io/api v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/apiextensions-apiserver => k8s.io/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/apimachinery => k8s.io/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/apiserver => k8s.io/kubernetes/staging/src/k8s.io/apiserver v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/cli-runtime => k8s.io/kubernetes/staging/src/k8s.io/cli-runtime v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/client-go => github.com/cilium/client-go v0.0.0-20190729115255-a56ab6424fcd
	k8s.io/cloud-provider => k8s.io/kubernetes/staging/src/k8s.io/cloud-provider v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/cluster-bootstrap => k8s.io/kubernetes/staging/src/k8s.io/cluster-bootstrap v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/code-generator => k8s.io/kubernetes/staging/src/k8s.io/code-generator v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/component-base => k8s.io/kubernetes/staging/src/k8s.io/component-base v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/cri-api => k8s.io/kubernetes/staging/src/k8s.io/cri-api v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/csi-translation-lib => k8s.io/kubernetes/staging/src/k8s.io/csi-translation-lib v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/gengo => k8s.io/gengo v0.0.0-20190116091435-f8a0810f38af
	k8s.io/heapster => k8s.io/heapster v1.2.0-beta.1
	k8s.io/klog => k8s.io/klog v0.3.1
	k8s.io/kube-aggregator => k8s.io/kubernetes/staging/src/k8s.io/kube-aggregator v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/kube-controller-manager => k8s.io/kubernetes/staging/src/k8s.io/kube-controller-manager v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20190228160746-b3a7cee44a30
	k8s.io/kube-proxy => k8s.io/kubernetes/staging/src/k8s.io/kube-proxy v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/kube-scheduler => k8s.io/kubernetes/staging/src/k8s.io/kube-scheduler v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/kubelet => k8s.io/kubernetes/staging/src/k8s.io/kubelet v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/kubernetes => k8s.io/kubernetes v1.15.1
	k8s.io/legacy-cloud-providers => k8s.io/kubernetes/staging/src/k8s.io/legacy-cloud-providers v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/metrics => k8s.io/kubernetes/staging/src/k8s.io/metrics v0.0.0-20190612082741-7dcec919a2e5
	k8s.io/repo-infra => k8s.io/repo-infra v0.0.0-20181204233714-00fe14e3d1a3
	k8s.io/sample-apiserver => k8s.io/kubernetes/staging/src/k8s.io/sample-apiserver v0.0.0-20190612082741-7dcec919a2e5
